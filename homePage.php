...
<head>
	...
	<link rel="stylesheet" href="demos/cafe/cafe.css" type="text/css" />
	<!-- / -->
	<link rel="stylesheet" href="demos/cafe/css/fonts.css" type="text/css" />
...
<body class="stretched overlay-menu dark">
						...
						<div id="discover" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.2.5.4">
							<ul>	<!-- SLIDE  -->
								<li data-index="rs-80" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="default"  data-rotate="0"  data-saveperformance="off"  data-title="Grid" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
									...
									<!-- MAIN IMAGE -->
									<img src="mainbg.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="3" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->

									<!-- LAYER NR. 1 -->

									<a class="tp-caption   tp-resizeme  ddd_mousebox tp-rs-menulink"
							 href="main.html" target="_self"			 id="slide-80-layer-16"
										...
										style="z-index: 5;cursor:pointer;"><img src="include/rs-plugin/demos/assets/images/dummy.png" alt="" data-ww="['50px','50px','50px','50px']" data-hh="['50px','50px','50px','340px']" data-lazyload="logo.png" data-no-retina> </a>

									<!-- LAYER NR. 2 -->
									<a class="tp-caption   tp-resizeme  ddd_mousebox tp-rs-menulink"
							 href="profilePage.php" target="_self"			 id="slide-80-layer-17"
									...
									<!-- LAYER NR. 3 -->
									<a class="tp-caption   tp-resizeme  ddd_mousebox tp-rs-menulink"
							 href="matchingPage.php" target="_self"			 id="slide-80-layer-18"
									...
									<!-- LAYER NR. 4 -->
									<a class="tp-caption   tp-resizeme  ddd_mousebox tp-rs-menulink"
							 href="logout.php" target="_self"			 id="slide-80-layer-19"
										 data-x="['center','center','center','center']" data-hoffset="['0','0','-1','0']"
										...
										style="z-index: 8;cursor:pointer;"><img src="include/rs-plugin/demos/assets/images/dummy.png" alt="" data-ww="['390px','321px','239px','390px']" data-hh="['340px','280px','208px','340px']" data-lazyload="include/rs-plugin/demos/assets/images/discover4.jpg" data-no-retina> </a>
									...
									<div class="tp-caption   tp-resizeme  nopointerevent rs-parallaxlevel-1"
										...
										style="z-index: 11; min-width: 390px; max-width: 390px; white-space: nowrap; font-size: 20px; line-height: 30px; font-weight: 900; color: rgba(255, 255, 255, 1.00);font-family:Lato;text-align:center;">GET STARTED! <br> Matching Page<br/> </div>
									...
									<div class="tp-caption   tp-resizeme  nopointerevent rs-parallaxlevel-1"
										...
										style="z-index: 12; min-width: 390px; max-width: 390px; white-space: nowrap; font-size: 20px; line-height: 30px; font-weight: 900; color: rgba(255, 255, 255, 1.00);font-family:Lato;text-align:center;">Logout </div>
